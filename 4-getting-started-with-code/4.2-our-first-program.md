...
Save the above code in the script.js file. [Send the code file as a snippet](../course-logistics/course-methodology.md#slack-code-snippets) in your section Slack channel.
