...
2. Start implementing the game as if you were to build the game from scratch. If you need / want to, clone a copy of the [starter code](https://github.com/rocketacademy/swe101-starter-code) to work out some ideas. How you would start the game and which parts you would work on first?
3. After you've decided how you would implement the game and in what order you would implement it, begin the videos and see how things went similarly or differently from how you imagined.
