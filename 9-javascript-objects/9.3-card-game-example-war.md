...
We implemented the card game [War](<https://en.wikipedia.org/wiki/War_(card_game)>) as an example of how to think about the logic of a program and the step-by-step process of how to build the different parts.

## Exercise

1. Read the [Wikipedia page for War](<https://en.wikipedia.org/wiki/War_(card_game)>) and write pseudocode for this game.
