...
This course did not cover HTML and CSS in depth. HTML and CSS are **not** programming languages, and are used for formatting, layout, and styling the elements that are displayed by the browser.&#x20;

In [10.2: Browser Application with DOM](12.1-browser-applications-with-dom.md), we will learn how to make our web applications more interactive by using JavaScript _logic_ to change the previously-static elements that are rendered by the browser. We can effective write programs that change what the user sees. We can tell the browser _"Change the background color of this element"_ or _"disable this button if the user runs out of money"_ or, if you are feeling nefarious _"make this pop-up appear"_.
