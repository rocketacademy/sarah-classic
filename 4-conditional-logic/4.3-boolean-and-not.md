...
In [4.2: Pseudo-Code, Boolean Or](broken-reference) we learned how to pseudo-code and use logical OR operators. In this module we will learn about the following.
