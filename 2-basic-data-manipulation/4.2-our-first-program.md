...
1. [Download the zipped folder](https://github.com/rocketacademy/basics-starter-code/archive/refs/heads/main.zip) of the Coding Basics Starter template and extract it to an appropriate location in your computer - see the [suggested folder structure](https://basics.rocketacademy.co/course-logistics/required-hardware-and-software/required-software-2#suggested-folder-structure-for-coding-basics).
2. [Open your Basics folder in VSCode](https://basics.rocketacademy.co/course-logistics/required-hardware-and-software/required-software-2#open-basics-folder-in-vscode).
...
We can also assign variables or even mathematical operations to `myOutputValue`. Our previous code from [3.2: Variables](3.2-variables.md) looked like this.
