...
We can also assign variables or even mathematical operations to `myOutputValue`. Our previous code from [3.2: Variables](../2-basic-data-manipulation/2.2-variables.md) looked like this.
