...
Let's run code outside the browser console. We'll create a basic program with a Sarah Classic starter template.

## Setup

1. [Download the zipped folder](https://github.com/rocketacademy/fundamentals-starter-code/archive/refs/heads/main.zip) of the Sarah Classic Starter template and extract it to an appropriate location in your computer - see the [suggested folder structure](../course-logistics/required-hardware-and-software/recommended-set-up.md).
