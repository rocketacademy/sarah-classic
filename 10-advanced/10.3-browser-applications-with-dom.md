...
{% hint style="info" %}
Similar to how we started with entering commands into the console in [1.1 Operations](../3-basic-data-manipulation/3.1-operations.md), we will first explore and experiment with the DOM in the browser console. Visit your [deployed site](https://rocketacademy.github.io/basics-starter-code-2.0/) and follow along in the console. _(See_ [_here_](broken-reference) _for instructions on how to deploy your site.)_
{% endhint %}
