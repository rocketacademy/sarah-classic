...
For the following exercises, start with the [SWE101 Starter Code repo](https://github.com/rocketacademy/swe101-starter-code) and replace the code in `script.js` with the following dice game code.
