...
{% hint style="info" %}
Share your work with your section: save the code you write into another file. Name it `share.js` \(A file only for sharing in Slack.\) [Send the code file as a snippet](../course-logistics/course-methodology.md#slack-code-snippets) in your section Slack channel.
{% endhint %}
...
Estimate the price of painting your home. The user will enter a dollar amount of paint per litre and the app will calculate how much it will cost.  
Each room in your 6-room house is the same size: 3m x 3m. There are 6 windows and 8 doors in your designer home. Coincidentally, windows and doors all of the same size: 90cm x 150cm. Paint will cover 300 square meters per litre. You want to apply 2 coats.  \([Ref Solution](https://github.com/rocketacademy/basics-starter-code/tree/5.1-refSolns-housePaint)\)
