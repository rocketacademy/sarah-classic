...
Each room in your 6-room house is the same size: 3m x 3m. There are 5 windows and 8 doors in your designer home. Coincidentally, windows and doors all of the same size: 90cm x 150cm. Paint will cover 300 square meters per litre. You want to apply 2 coats.  \([Ref Solution](https://github.com/rocketacademy/basics-starter-code/tree/5.1-refSolns-housePaint)\)
