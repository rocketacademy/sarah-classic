...
In Basics we'll be learning Git so that we can keep track of different versions of our code. In [8.2 (GitHub Repo Browsing)](../7-github/7.2-github-repo-browsing.md) we'll cover how to browse and get back these older versions, but in this section we'll only cover some basic actions within Git and how to record the versions of our code in the first place.
...
### Committing and Tracking Changes to Project 2

Navigate to your _Beat That!_ directory, and initialise it as a git repo. Make your first commit with a meaningful, but brief message describing your current progress on the project. As you continue adding to the project, make meaningful commits at each checkpoint. Approach your Section Leader if you have any questions. When we learn how to use and navigate GitHub, we will be able to visualise our progress, and travel through time via these commits. See an [example](https://github.com/lim-jiahao/basics-beat-that/commits/main) of how this can look like.
