...
{% hint style="info" %}
Save your code into a single script.js file. [Send the code file as a snippet](../course-logistics/course-methodology.md#slack-code-snippets) in your section Slack channel.
{% endhint %}
