...
We've written pseudo-code. We've written JavaScript. We've controlled our logic so it can be tested. Our code could still have errors! How do we find these errors? Let's analyse common conditional errors and learn strategies to find and diagnose them.

### Deconstructing and Checking Your Conditions

We have started to write more complex conditionals that comprise several boolean statements connected by logical operators such as `||`, `&&`, and `!`. 
