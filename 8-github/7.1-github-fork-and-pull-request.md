...
3. Once the repo is on our computer, make the changes we want, and follow the Git workflow and cheatsheet [here](../7-version-control/2.2-git.md#cheat-sheet) to commit those changes.
