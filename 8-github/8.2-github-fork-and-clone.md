...
3. Once the repo is on our computer, make the changes we want, and follow the Git workflow and [cheatsheet ](../7-organising-and-managing-code-files/7.1-git.md#cheat-sheet)to commit those changes.
